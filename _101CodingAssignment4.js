...
const Header=()=>{
    ...
    <div className="logoContainer">
        <img id="logo" src="https://cdn-icons-png.flaticon.com/128/3579/3579034.png" />
    </div>
...
const RestaurantCart=(props)=>{
    ...
    return(
        <div className="res-card" style={styleCard}>
            <img className="restImg" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId} />
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
            <h4>{avgRating}</h4>
    ...
    return (
        <div className="bodyContainer">
            <div className="searchContainer">
                <lable id="myLabel" for="search">Search</lable>
                <input id="search" placeholder="Search Restaurant" type="text" />
            </div>
